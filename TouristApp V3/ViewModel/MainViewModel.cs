...
namespace TouristApp_V3.ViewModel
{
    class MainViewModel : ObservableObject
    {
        ...
        {
            get { return new DelegateCommand(AddCat); }
        }

        public ICommand AddItem
        {
            get { return new DelegateCommand(AddIt); }
        }
        ...
        {
            await new Windows.UI.Popups.MessageDialog("hovno").ShowAsync();
        }

        public async void AddIt()
        {
            await new Windows.UI.Popups.MessageDialog("Coming soon ;)").ShowAsync();
        }
        ...
        public void MakeOrder()
        {
            ...
            OrderViewModel.Total.String = Convert.ToString(total);
        }
        #endregion
